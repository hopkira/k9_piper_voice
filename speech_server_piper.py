# Client that leverages the local piper voice
...
from ../k9/memory import Memory
from ../k9/eyes import Eyes
...
def speak_piper(speech:str) -> None:
    '''
    Use local piper speech program to render speech
    '''
    ...
    cmd = [echo 'I am kay nine mark five and I am a very good dog.' | \
